        ...
        <div>
            ...
            <div style={{ display: 'flex', justifyContent: "space-around", alignItems: "center", flexWrap: "wrap", textAlign: 'center' }}>
                ...
                <div>
                    ...
                    <p className='category' style={{ fontWeight: "bolder", fontFamily: "serif", marginTop: "10px" }} >PROPERTY FOR SELL</p>
                </div>
                <div>
                    <img style={{ width: '60%' }} src="https://www.olx.com.pk/assets/property-for-rent.8436595fbaa90d47f0178006f57090a8.png" alt="" ></img>
                    <p className='category' style={{ fontWeight: "bolder", fontFamily: "serif", marginTop: "10px" }} >PROPERTY FOR RENT </p>
                </div>
                <div>
                    ...
                    <p className='category' style={{ fontWeight: "bolder", fontFamily: "serif", marginTop: "10px" }} >CAMERA</p>
                </div><div>
                    ...
                    <p className='category' style={{ fontWeight: "bolder", fontFamily: "serif", marginTop: "10px" }} >TRUCKS</p>
                </div><div>
                    <img style={{ width: '60%' }} src="https://www.olx.com.pk/assets/services.dc6aef196c0403dc61b0ee813f66fa5b.png" alt="" ></img>
                    <p className='category' style={{ fontWeight: "bolder", fontFamily: "serif", marginTop: "10px" }} >SERVICES</p>
                </div><div>
